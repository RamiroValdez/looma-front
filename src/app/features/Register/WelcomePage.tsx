...
const WelcomePage: React.FC = () => {
  ...
  return (
    <div
      className="min-h-screen flex items-center md:justify-center w-full px-4 md:px-0 md:pr-24"
      style={{
        background:
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-center w-full max-w-6xl gap-8 md:gap-0">
        ...
        <div className="flex flex-col items-center w-full md:w-auto">
          ...
          <button
            onClick={handleStart}
            className="bg-[#5c17a6] hover:bg-[#3c2a50] text-white text-lg sm:text-xl md:text-2xl px-10 sm:px-16 md:px-24 py-3 sm:py-4 rounded-[14px] font-semibold transition-all shadow-md w-full max-w-xs"
          >
            Explorar
          </button>
        </div>
