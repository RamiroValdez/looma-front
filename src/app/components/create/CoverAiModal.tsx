...
import { useArtisticStyles } from "../../../infrastructure/services/ArtisticStylesService.ts";
import { useArtisticStyleStore } from "../../../infrastructure/store/ArtisticStyleStore.ts";
import { useColorPalettes } from "../../../infrastructure/services/ColorPaletteService.ts";
import { useColorPaletteStore } from "../../../infrastructure/store/ColorPaletteStore.ts";
import { useCompositions } from "../../../infrastructure/services/CompositionService.ts";
import { useCompositionStore } from "../../../infrastructure/store/CompositionStore.ts";
...
const CoverAiModal: React.FC<CoverIaModalProps> = ({
  ...
  useEffect(() => {
    if (isOpen) setHasTriedGenerate(false);
  }, [isOpen]);
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-4 w-full">
              <div className="flex flex-col items-start text-left gap-6 rounded-xl py-8 px-8 w-full md:w-1/2">
                <div className="w-full flex flex-col">
                  ...
                  {hasTriedGenerate && !selectedArtisticStyle && (
                ...
                <div className="w-full flex flex-col">
                  ...
                  {hasTriedGenerate && !selectedColorPalette && (
                ...
                <div className="w-full flex flex-col">
                  ...
                  {hasTriedGenerate && !selectedComposition && (
      ...
      {waitingMessage && (
        <div className="fixed inset-0 flex items-center text-center justify-center z-50 bg-black/50">
          <div className="bg-white rounded-lg flex flex-col text-center justify-center items-center p-10">
            ...
            <p className="text-center text-gray-600 mt-2">Generando portada, por favor espera...</p>
          </div>
        </div>
      )}
    </div>
